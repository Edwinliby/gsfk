    ...
    return (
        <>
            ...
            <div className={styles.currentEvent} id='about'>
                ...
                <h2>Through a union of a union Science & Art</h2>
                ...
                <br /> <br /><br />
                <h2 style={{ paddingBottom: "1rem" }}>AT A GLANCE</h2>
                ...
                <div className={styles.QAList}>
                    ...
                    <div className={styles.questions}>
                        ...
                        <span>
                            <h1>WHERE?</h1>
                            <p>
                                Science Expo is planned at the <a href="https://maps.app.goo.gl/iFQURcetJMQVaknDA"><b>Kozhikode Beach</b></a>.
